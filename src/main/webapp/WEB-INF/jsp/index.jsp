<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="java.util.List,com.example.netdisk.bean.FileIndex" %>
...
%>
      	...
      	<button class="btn btn-warning btn-xs" data-toggle="modal" data-target="#renameForm" onclick="setRenameForm('<%=rootDir.getName() %>','<%=rootDir.getPath() %>','yes')">
